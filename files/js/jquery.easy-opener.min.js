...
jQuery(document).ready(function($) {
    jQuery("body").on("click", ".easy-opener", function() {
        jQuery("body").addClass("easy-opener-is-open");
        ...
        if (!direction) createOpener();
        else jQuery(".easy-opener-content").animate({
                opacity: 0
            },
            10,
            function() {});
    ...
    jQuery("body").on("click",
        ".easy-opener-close, .easy-opener-bg",
        function() {
            jQuery("body").removeClass("easy-opener-is-open");
            jQuery("#easy-opener-section").fadeOut(100, function() {
                jQuery(".easy-opener-content").html("").animate({
                    opacity: 0
                }, 10, function() {
...
function createVideo(maxW, maxH, elW, elH, vid) {
    ...
    jQuery("#easy-opener-section").fadeIn(100, function() {
