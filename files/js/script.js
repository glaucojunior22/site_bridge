...
jQuery(window).load(function($) {	
	...
	/*----------------------------------------------
			C H A N G E  I M G  C O L O R
	------------------------------------------------*/
	jQuery('.change-color').mouseenter(function(){
		var imgName = jQuery(this).find('img').attr('src');
		var newName = imgName.replace('-pb', '');
		jQuery(this).find('img').attr('src', newName);
	})

	jQuery('.change-color').mouseleave(function(){
		var imgName = jQuery(this).find('img').attr('src');
		var newName = imgName.replace('.png', '-pb.png');
		jQuery(this).find('img').attr('src', newName);
	});
